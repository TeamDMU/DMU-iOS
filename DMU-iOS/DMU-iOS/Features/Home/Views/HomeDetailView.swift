...
struct HomeDetailView: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            HomeDetailNoticeScrollView(homeDetailNotice: homeDetailNotice, homeDetailViewNavigationBarTitle: homeDetailViewNavigationBarTitle, presentationMode: presentationMode, viewModel: viewModel)
        }
    }
}

// MARK: -공지사항 디테일 화면 스크롤 뷰
struct HomeDetailNoticeScrollView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading) {
                HomeDetailNoticeKeywordAndButtonBar(homeDetailNotice: homeDetailNotice)
                
                HomeDetailNoticeTitle(homeDetailNotice: homeDetailNotice)
                
                HomeDetailNoticeStaffNameAndDateBar(homeDetailNotice: homeDetailNotice, viewModel: viewModel)
                
                HomeDetailNoticeContentDetail(homeDetailNotice: homeDetailNotice)
...
// MARK: -공지사항 디테일 화면 키워드 뷰, 공유하기 버튼
struct HomeDetailNoticeKeywordAndButtonBar: View {
    ...
    var body: some View {
        HStack {
            Text(homeDetailNotice.noticeKeyword)
...
// MARK: -공지사항 디테일 화면 공지사항 제목 텍스트
struct HomeDetailNoticeTitle: View {
    
    let homeDetailNotice: Notice
    
    var body: some View {
        Text(homeDetailNotice.noticeTitle)
            .font(.SemiBold20)
...
struct HomeDetailNoticeStaffNameAndDateBar: View {
    ...
    var body: some View {
        HStack {
            Text(homeDetailNotice.noticeStaffName)
                .font(.Medium14)
            ...
            Text(viewModel.formatDate(homeDetailNotice.noticeDate))
                .font(.Medium14)
                .foregroundColor(Color.Gray400)
                .padding(.leading, 8)
        }
...
// MARK: -공지사항 디테일 화면 공지사항 디테일 뷰
struct HomeDetailNoticeContentDetail: View {
    
    let homeDetailNotice: Notice
    
    var body: some View {
        Text(homeDetailNotice.noticeDetail)
            .padding(.top)
            .font(.Medium16)
