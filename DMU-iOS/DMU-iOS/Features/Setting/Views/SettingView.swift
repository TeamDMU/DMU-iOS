        ...
        NavigationStack {
            ZStack {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    NavigationLink(destination: SettingWebViewDetail(urlString: "https://tally.so/r/n9oq91")) {
                        HStack {
                            Text("문의하기")
                                .font(.Medium18)
                                .foregroundColor(Color.Gray500)
                    ...
                    NavigationLink(destination: SettingWebViewDetail(urlString: "https://sites.google.com/view/dmforu-privacy-policy/%ED%99%88")) {
                        HStack {
                            Text("개인정보 처리방침")
                                .font(.Medium18)
                                .foregroundColor(Color.Gray500)
