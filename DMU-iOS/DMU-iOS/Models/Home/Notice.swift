...
let sampleData = [
    ...
    Notice(title: "DMMC 상반기 창업 육성 세미나 수강생 모집2", date: Date(), staffName: "김아름", noticeType: "대학공지"),
    Notice(title: "DMMC 상반기 창업 육성 세미나 수강생 모집3", date: Date(), staffName: "김아름", noticeType: "대학공지"),
    Notice(title: "DMMC 상반기 창업 육성 세미나 수강생 모집4", date: Date(), staffName: "김아름", noticeType: "대학공지"),
